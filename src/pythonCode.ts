...
class ContextGraphEngine:
    """The Brain: Background Swarm Task running every 2 minutes."""
    ...
    async def build_context_graph(self) -> ContextGraph:
        ...
        if len(price_dict) >= 5 and min_len >= 5:
            ...
            top_leaders = {s for s, _ in candidate_leaders[:6]}
...
class SniperExecutioner:
    """Layer 2: The Executioner on Binance Public WebSockets."""
